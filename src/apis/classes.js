...
const services = {
  ...
  Classes: {
    url: 'https://api.mindbodyonline.com/0_5_1/ClassService.asmx?wsdl',
    endpoint: 'https://api.mindbodyonline.com/0_5_1/ClassService.asmx'
  }
};
...
const connectClassService = () =>
  createSoapClient(services.Classes.url, services.Classes.endpoint);
...
class MindBodyAPI {
  ...
  async GetClasses(data = {}) {
    const classes = await connectClassService();
    ...
    return new Promise((resolve, reject) =>
      classes.Class_x0020_Service.Class_x0020_ServiceSoap.GetClasses(
        params,
        (err, result) => {
          if (err) reject(err);
          else {
  ...
  async GetClassSchedules(data = {}) {
    ...
    return new Promise((resolve, reject) =>
      classes.Class_x0020_Service.Class_x0020_ServiceSoap.GetClassSchedules(
        params,
        (err, result) => {
          if (err) reject(err);
          else {
